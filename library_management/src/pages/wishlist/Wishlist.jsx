...
function Wishlist() {
    ...
    try {
      ...
      const orders = wishlist.map((book) => {
        ...
        return {
          ...
          returnDate: new Date(localTime.getTime() + (14 * 24 * 60 * 60 * 1000)).toISOString(),
          status: "Pending",
        };
      });
  ...
  return (
    <>
      <Header />
      <ToastContainer />
      <div className="Wishlist" style={{ padding: "40px 0 20px 0", backgroundColor: "#E1DCC5", height: "100%" }}>
        <div className="container mt-4">
          <h1 style={{ marginTop: "20px", paddingTop: "60px" }}>Your Wishlist</h1>
          {wishlist.length > 0 ? (
            <>
                    ...
                    <tr key={book.bookID}>
                      ...
                      <td>
                        <select
                          ...
                          onChange={(e) => handleQuantityChange(book.bookID, e.target.value)}
                        >
